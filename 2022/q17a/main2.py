...
class Game:
    ...
    def do_turn(self):
        self.store_heights.append(self.get_high())
...
game = Game(rocks, input, turns=20000)
game.play() 
print(game.get_high()-1)
steps = np.diff(game.store_heights)
...
prova = autocor(steps)
period = np.argmax(prova[40:]) + 40


dream = 1_000_000_000_000
n_periods = dream // period
period_size = game.store_heights[period*3] - game.store_heights[period*2]
print(((n_periods -1) * period_size) + game.store_heights[dream%period + period] - 1)
